...
- [架构文档](docs/architecture.md) - 系统设计和架构
- [七牛云配置](.codebuddy/examples/qiniu-config.example.json) - 配置示例
- [加密配置](.codebuddy/examples/encryption-config.example.json) - 加密示例
...
- [七牛云](https://www.qiniu.com/) - 云存储服务提供商
